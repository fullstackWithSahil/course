...
export default async function layout({ children }: { children: ReactNode }){
	...
	return (
		<main className="w-full h-[97vh] px-2 sm:px-4 relative top-0 left-0 border-2">
			<section className="absolute top-0 left-0 hidden sm:flex sm:w-[50%] md:w-[33%] lg:w-[25%] z-0 transition-colors duration-200 flex-col items-center gap-3 pt-5 border-r-2 border-gray-600 dark:border-white h-[calc(100vh-67px)]">
